...
export const WeddingInvitationPage = () => {
      ...
      const dateYYYYMMDD = useWeddingBoundStore((state) => state.eventYYYYMMDD());
      const dateHHMM = useWeddingBoundStore((state) => state.eventHHMM());
      ...
      const setConfirmationWedding = useWeddingBoundStore(
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-5 w-5"
                    checked={!isConfirmed}
                    onChange={() => setConfirmationWedding(!isConfirmed)}
                  />
                  <label className="pl-3 text-base font-medium text-[#07074D]">
                    No
                  </label>
